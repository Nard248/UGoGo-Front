    ...
    useEffect(() => {
        ...
        setOfferFormData({
            ...offerFormData, ...{
                ...
                takeoff_date: data.takeoff_date
            }
        })
    }, [data]);
    ...
    return (
        <div className="search-bar">
            <div className="search-field">
                ...
                />
                {offerFormData.from_airport_id.errorMessage &&
                    <span className="text-[1.4rem] text-[#F04438] font-normal ml-[.5rem]">
                        {offerFormData.from_airport_id.errorMessage}
                    </span>
                }
            </div>
            ...
            <div className="search-field">
                ...
                />
                {offerFormData.to_airport_id.errorMessage &&
                    <span className="text-[1.4rem] text-[#F04438] font-normal ml-[.5rem]">
                        {offerFormData.to_airport_id.errorMessage}
                    </span>
                }
                ...
                <div className="search-field">
                    ...
                    >
                        <>
                            ...
                            {offerFormData.departure_datetime.errorMessage &&
                                <span className="text-[1.4rem] text-[#F04438] font-normal ml-[.5rem]">
                                    {offerFormData.departure_datetime.errorMessage}
                                </span>
                            }
