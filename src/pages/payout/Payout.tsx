                ...
                <div className="flex justify-between gap-[2rem]">
                    ...
                    <div className="flex flex-col gap-[3rem] w-[40%]">
                        ...
                        <Label title="Amount to transfer" htmlFor="amount">
                            <Input type="number" placeholder="USD" handleChange={() => {
                            }}/>
                        </Label>
                        <Button type="primary" title="Transfer to the card"/>
                    </div>
                </div>
            </div>
            {isAddCardPopupOpen && createPortal(<AddCardPopup onClose={() => setIsAddCardPopupOpen(false)} />, document.body)}
        </div>
    )
}